...
//MAKATY
uint32 kalloc_size[(int)(1<<20)]; // this will be used when freeing the pages
int32 frameToPageMapping[(1<<20)]; // this will act as a hash map for mapping the frames to pages
//MAKATY
